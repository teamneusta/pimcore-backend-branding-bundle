...
use Neusta\Pimcore\BackendBrandingBundle\CssProvider\SidebarColor;
use Neusta\Pimcore\BackendBrandingBundle\Settings;
use PHPUnit\Framework\TestCase;
use Spatie\Snapshots\MatchesSnapshots;

class SidebarColorTest extends TestCase
{
    ...
    public function it_is_empty_when_not_configured(): void
    {
        ...
        $sidebarColor = new SidebarColor($settings);
        $ruleList = new CssRuleList();

        $ruleList->addRules($sidebarColor->__invoke());
